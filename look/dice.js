...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-ea4b5b14');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-ea4b5b14');}
...
var brandEl=document.querySelector('.rl-brand-ea4b5b14');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
